...
function createProductCard(product) {
    return `
        <div class="product-card bg-white rounded-lg shadow p-6 flex flex-col items-center">
            <a href="/my-watch-colne/frontend/src/views/store/product-info.html?id=${product.id}" class="product-image-container relative w-full flex justify-center">
                <img src="${product.image}" alt="${product.name}" class="product-image w-64 h-64 object-contain">
            </a>
            <h3 class="font-semibold text-lg mb-2">${product.name}</h3>
            <p class="text-gray-500 text-base mb-2">${product.price.toFixed(2)} MAD</p>
